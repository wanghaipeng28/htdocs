...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'enableAjaxValidation'=>false,
		...
		<?php echo $form->label($model,'title',array('style'=>'padding-left:5px;')); ?>
                <?php
                    if(ResultInfo::RESULT_PASSED ==  $model->result_value)
                    {
                        echo '<span class="resultvalue_passed">&nbsp;</span>';
                    }
                    else
                    {
                        echo '<span class="resultvalue_failed">&nbsp;</span>';
                    }
                ?>
        ...
        <div style="clear:both;">
            <fieldset style="width: 32%;float: left;">
                ...
                <div class="row">
                    ...
                    <?php echo CHtml::encode($model->mail_to); ?>
                </div>
