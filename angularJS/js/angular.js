(function(window, document, undefined) {
  ...
  function minErr(module, ErrorConstructor) {
    ...
    return function() {
      ...
      message = message + '\nhttp://errors.angularjs.org/1.3.7/' + (module ? module + '/' : '') + code;
        ...
        if (isArray(o1)) {
          ...
          for (key in o1) {
            if (key.charAt(0) === '$' || isFunction(o1[key]))
              continue;if (!equals(o1[key], o2[key]))
              return false;
            keySet[key] = true;
          }
          for (key in o2) {
      ...
      function compileTemplateUrl(directives, $compileNode, tAttrs, $rootElement, childTranscludeFn, preLinkFns, postLinkFns, previousCompileContext) {
        ...
        $templateRequest($sce.getTrustedResourceUrl(templateUrl)).then(function(content) {
          ...
          while (linkQueue.length) {
            ...
            if (scope.$$destroyed)
              continue;if (beforeTemplateLinkNode !== beforeTemplateCompileNode) {
      ...
      if (pathKeysLength < 6) {
        ...
        fn = function cspSafeGetter(scope, locals) {
          ...
          do {
            ...
            locals = undefined;
            scope = val;
          } while (i < pathKeysLength);return val;
        }
        ;
      }
    } else {
      ...
      Scope.prototype = {
        ...
        $digest: function() {
          ...
          do {
            ...
            } while ((current = next));if ((dirty || asyncQueue.length) && !(ttl--)) {
              clearPhase();
        ...
        $emit: function(name, args) {
          ...
          do {
            ...
            scope = scope.$parent;
          } while (scope);event.currentScope = null ;
          return event;
        },
          ...
          $scope.$watchCollection(rhs, function ngRepeatAction(collection) {
            ...
            for (index = 0; index < collectionLength; index++) {
              ...
              if (block.scope) {
                ...
                } while (nextNode && nextNode[NG_REMOVED]);if (getBlockStart(block) != nextNode) {
